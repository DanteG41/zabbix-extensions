...
# Description:	size of inherited tables by name of parent table.
...
q="SELECT sum(pg_relation_size(inhrelid::regclass)) FROM pg_inherits WHERE inhparent = '$1'::regclass::oid;"
